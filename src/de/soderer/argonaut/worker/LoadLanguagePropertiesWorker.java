...
public class LoadLanguagePropertiesWorker extends WorkerSimple<Boolean> {
	...
	public Boolean work() throws Exception {
		...
		if (languagePropertiesFileOrBasicDirectory == null) {
			throw new ArgonautException("Language properties file or basic directory parameter is empty");
		} else if (!languagePropertiesFileOrBasicDirectory.exists()) {
			throw new ArgonautException("Language properties file or basic directory '" + languagePropertiesFileOrBasicDirectory + "' does not exist");
