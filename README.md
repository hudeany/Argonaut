...
Please send suggestions for improvements or bug reports to: Argonaut@soderer.de
...
Usage:
	java -jar Argonaut.jar -exportToExcel <language properties file or directory path> -excelFile <output Excel file path> [-v]
	or
	java -jar Argonaut.jar -exportToCsv <language properties file or directory path> -csvFile <output CSV file path> [-v]
	or
	java -jar Argonaut.jar -importFromExcel <input Excel file path> [-outputDirectory <language properties output directory>] [-v]
	or
	java -jar Argonaut.jar -importFromCsv <input CSV file path> [-outputDirectory <language properties output directory>] [-v]
